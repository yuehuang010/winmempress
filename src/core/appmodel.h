...
struct ProcessInfo {
    ...
    std::uint64_t create_time = 0, working_set = 0, commit = 0, page_faults = 0;
    std::wstring image_name, exe_path, package_family_name;
};
struct SystemStats {
    std::uint64_t commit_total = 0, commit_limit = 0, physical_total = 0;
    std::uint64_t physical_available = 0, page_faults = 0, memory_compression_working_set = 0;
};
struct Snapshot {
...
struct AppEntry {
    ...
    std::uint64_t working_set = 0, commit = 0, page_faults = 0;
